...
int main(int argc, char *argv[]) {
    ...
    // It is an important one, it set an ending character(26th) '\0', the purpose is to make that the data stored in initial_board is a valid string, because the string in C must end with NULL
    initial_board[25] = '\0';

    // Atoi function convert string from arguments to integer
    ...
    // If I find any character not 'X' or 'O' or '*', it will print a message and then return 1(same function like above)
    for (int i = 0; i < 25; i++) {
